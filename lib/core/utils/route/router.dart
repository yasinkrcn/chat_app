...
import 'package:chat_app/feature/story/presentation/view/pages/story_add_page.dart';
...
class PageRoutes {
  ...
  static const String storyAddPage = "/storyAddPage";
}
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case PageRoutes.storyAddPage:
      return CupertinoPageRoute(builder: (_) => const StoryAddPage());
